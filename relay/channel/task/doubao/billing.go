...
//
// ModelRatio 基础值 = 3.15（对应 720p 无视频参考 ¥46/M tokens）
// SKU 倍率用于区分不同分辨率和视频参考的定价差异
//
// 计费公式：
//
//	预扣费 = modelRatio(3.15) × QuotaPerUnit × groupRatio × seedance_sku
//	结算费 = totalTokens × modelRatio(3.15) × seedance_sku × groupRatio
//
...
const (
	...
	// 对应 kapon ¥46/M tokens: 5.01 / 7.3 * 500000 / 108900 ≈ 3.15
	seedanceBaseModelRatio = 3.15
